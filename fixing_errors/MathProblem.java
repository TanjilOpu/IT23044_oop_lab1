...
public class MathProblem {
    ...
    public static void main(String[] args) {
        ...
        double theta = sc.nextDouble(); // Changed to double for greater precision
        ...
        double A = P * Math.pow(1 + r / n, n * t); // Fixed Math.pow
        ...
        double thetaPolar = Math.toDegrees(Math.atan2(y, x)); // Used atan2 for correct quadrant
